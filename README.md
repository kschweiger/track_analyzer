...
* **speed_ms**: Speed in m/s calculated relative to previous point. Requires time to be present in track.
* **distance_m**: Distance in m relative to previous point
...
* **cum_distance_m**: Cummulated distance in track/segement in meters.
* **cum_distance_moving_m**:  Cummulated moving distance in track/segement in meters.
* **cum_distance_stopped_m**:  Cummulated stopped distance in track/segement in meters.
