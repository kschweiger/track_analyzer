...
if __name__ == "__main__":
    ...
    track.plot(kind="profile", width=None, height=None).write_html(
        "_static/examples/visualization/profile_simple.html",
        full_html=False,
    )
    ...
    track.plot(
        ...
        "_static/examples/visualization/profile.html",
        full_html=False,
    )

    track.plot(kind="profile-slope", width=None, height=None).write_html(
        "_static/examples/visualization/profile_slope.html",
        full_html=False,
    )

    track.plot(kind="map-line", line_width=4, width=None, height=None).write_html(
        "_static/examples/visualization/map_line.html",
        full_html=False,
    )
    ...
    track_w_segments.plot(
        ...
        "_static/examples/visualization/map_segments.html",
        full_html=False,
    )

    track.plot(kind="map-line-enhanced", width=None, height=None).write_html(
        "_static/examples/visualization/map_line_enhanced.html",
        full_html=False,
    )
    ...
    track.plot(kind="map-line-enhanced", width=None, height=None).write_html(
        "_static/examples/visualization/map_line_enhanced_interpolated.html",
        full_html=False,
    )
