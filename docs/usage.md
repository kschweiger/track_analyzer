...
- _speed_ms_: Speed in m/s calculated relative to previous point. Requires time to be present in track.
- _distance_m_: Distance in m relative to previous point
...
- _cum_distance_m_: Cummulated distance in track/segement in meters.
- _cum_distance_moving_m_: Cummulated moving distance in track/segement in meters.
- _cum_distance_stopped_m_: Cummulated stopped distance in track/segement in meters.
